  ...
  export function sendReport(error_data, user_id = 0, successCallBackManager, errorCallBackManager){
    ...
    console.log("Error Reporting URL: ", url, final_bodyParam);
      ...
      //*> XML Http request
       ...
       request.setRequestHeader("ostype", Platform.OS);
       request.setRequestHeader("appversion", DeviceInfo.getVersion());
       request.setRequestHeader("appid", 'D2T');
